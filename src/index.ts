...
(async function () {
    ...
    try {
        ...
        await mongoose.connect("mongodb+srv://hicham5lehouedj:Hicham0675722241h@cluster2.ajmndot.mongodb.net/transformation-era?retryWrites=true&w=majority&appName=Cluster2");
