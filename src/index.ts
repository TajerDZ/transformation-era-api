...
(async function () {
    ...
    try {
        ...
        await mongoose.connect("mongodb://root:teLOkMeuvvEyYwsl4X8d7xMbb3ewfPOsg3lEJKunUHyz2ISpWYhGbJzBJ1SjkADt@147.93.108.152:5550/transformation-era?directConnection=true");
